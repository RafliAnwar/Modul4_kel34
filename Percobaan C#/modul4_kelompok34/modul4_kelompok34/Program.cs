...
namespace modul4_kelompok34
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            non_return("Muhammad Dzulfiqar Rafli Anwar", "Nuzulita Setiawati", "Kelompok34");
            Console.WriteLine("Ini adalah praktikum shift 1, Fungsi return mengembalikan nilai menjadi {0}", return_func(1));
